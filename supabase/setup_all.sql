-- =============================================================================
-- CricketArena — run this ENTIRE file in Supabase Dashboard → SQL → New query
-- Do NOT paste the file path. Paste the SQL below, then click Run.
-- =============================================================================

-- PART 1: SCHEMA (from 20260528000001_initial_schema.sql)
...
INSERT INTO public.subscription_plans (name, slug, description, price_inr, duration_days, max_tournaments, features, sort_order) VALUES
  ('Free', 'free', 'All features included — 100% free', 0, 365, 999, '["live_scores","scoring","points_table","unlimited_tournaments"]', 0);

-- PART 2: RLS POLICIES (from 20260528000002_rls_policies.sql)
